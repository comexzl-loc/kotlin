...
import org.jetbrains.kotlin.resolve.ClSealedClassInheritorsProvider
...
class DeserializedClassDescriptor(
    ...
    private fun computeSubclassesForSealedClass(): Collection<ClassDescriptor> {
        ...
        return ClSealedClassInheritorsProvider.computeSealedSubclasses(this, allowSealedInheritorsInDifferentFilesOfSamePackage = false)
    }
